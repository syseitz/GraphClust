...
#define WITHIN_CMFINDER /* so I can re-use cm_pipeline.c within actual Infernal, not with in the Infernal lib that's inside cmfinder */
...
extern int          cm_p7_Calibrate(P7_HMM *hmm, char *errbuf, int ElmL, int ElvL, int ElfL, int EgfL, int ElmN, int ElvN, int ElfN, int EgfN, double ElfT, double EgfT, double *ret_gfmu, double *ret_gflambda,char *hmmStatsToCalibrate);
